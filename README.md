...
### 12-02-2026
* Working on channel interface and implementing it for terminal.
 The bot will not use traditional command syntax (e.g., /help), but rather "normbot:help" (reason: maybe I am dumb).
